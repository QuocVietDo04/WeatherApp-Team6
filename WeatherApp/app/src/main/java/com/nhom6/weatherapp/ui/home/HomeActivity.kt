...
//                }
    ...
    private fun startNewActivity(action: HomeAdapter.ActionType) {
        when (action) {
            HomeAdapter.ActionType.SEARCH -> {
                val intent = Intent(this, SearchActivity::class.java)
                startActivity(intent)
            }
            HomeAdapter.ActionType.SETTING -> {
//                val intent = Intent(this, SettingActivity::class.java)
//                startActivity(intent)
            }
            HomeAdapter.ActionType.SAVED_LOCATION -> {
